...
# Select wines younger than 10 years and with more than 30 ratings
wines_price_lm <- wines %>% filter(y_old<=10, n_ratings >= 30)
lm_robust_model <- estimatr::lm_robust(wine_price ~ y_old + I(y_old^2) + wine_country + log(n_ratings) + wine_rating + log(n_ratings):wine_rating, data = wines_price_lm,se_type = "stata")
