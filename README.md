...
web scraping, please, refer to the [source.Rmd](source.Rmd) file. To download the data go to [https://www.kaggle.com/nikitatkachenko/VivinoRedWine](https://www.kaggle.com/nikitatkachenko/VivinoRedWine).
